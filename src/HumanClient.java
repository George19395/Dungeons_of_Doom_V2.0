...
//------------------------- Create huamns Buttons----------------------------------
		...
		JTextField InputText = new JTextField("Enter_Username:");
		InputText.setPreferredSize(new Dimension(150, 30));


		//disabling the buttons before username is set
		bMoveN.setEnabled(false);				
		bMoveW.setEnabled(false);
		bMoveE.setEnabled(false);
		bMoveS.setEnabled(false);
		bHello.setEnabled(false);
		bPickUp.setEnabled(false);
		bShout.setEnabled(false);
		bWhisper.setEnabled(false);
